...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-[#f7f8f5] text-slate-800" style={{ fontFamily: "Georgia, Times New Roman, serif" }}>
                ...
                <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-6 pb-24 pt-10 md:grid-cols-2 md:px-10 lg:px-16 lg:pt-14">
                    <div className="max-w-xl pt-4 md:pt-0">
                        ...
                        <div className="mt-8 flex flex-wrap gap-4">
                            ...
                            <Link
                                to="/services"
                                className="rounded-md border border-[#d9dfd3] bg-white px-8 py-4 font-sans text-xl font-medium text-[#1b2b4a] shadow-sm transition hover:bg-[#f4f6f1]"
                            >
                                View Care Options
                            </Link>
                        </div>
            ...
            <section className="relative bg-[#f8f7f3] px-6 pb-24 pt-10 md:px-10 lg:px-16">
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                        {services.map((service) => (
                            ...
                            >
                                ...
                                <Link to="/services" className="mt-7 inline-flex items-center gap-2 font-sans text-[20px] text-[#6e9c63]">
                    ...
                    <div className="mt-10 flex justify-center">
                        <Link
                            to="/services"
                            className="rounded-md bg-[#6f9a5c] px-12 py-4 font-sans text-xl text-white shadow-[inset_0_1px_0_rgba(255,255,255,.3),0_4px_10px_rgba(0,0,0,.08)]"
                        >
                            View All Services
                        </Link>
                    </div>
            ...
            <section className="relative overflow-hidden bg-[#f7f8f5] px-6 pb-24 pt-12 md:px-10 lg:px-16">
                ...
                <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-[1.12fr_.88fr]">
                    <div className="pt-4">
                        ...
                        <Link
                            to="/about"
                            className="mt-10 inline-block rounded-md bg-[#c8a24f] px-8 py-4 font-sans text-xl text-white shadow-[inset_0_1px_0_rgba(255,255,255,.25),0_5px_12px_rgba(0,0,0,.08)]"
                        >
                            Learn More About Us
                        </Link>
                    </div>
